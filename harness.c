...
const ptrdiff_t ADDR_JNI_ONLOAD = 0x00010960; // 0x0000000000011640;
const ptrdiff_t ADDR_PARSE_LINK = 0x0002b6d8; // 0x000000000002F870;
const ptrdiff_t ADDR_COPY_JNI_STRING_FROM_STR = 0x000104ac; // 0x0000000000011160;
const ptrdiff_t ICU_SQLITE_ANDROID_BINDER__INIT = 0x00006654; // 0x0000714788297F90;
const ptrdiff_t g_ICU_VERSION = 0x00018000; // 0x00007147882A9000;
const uint32_t ICU_VERSION = 63;
